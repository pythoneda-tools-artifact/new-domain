...
"""
pythoneda/tools/artifact/new_domain/events/definition_repository_changes_pushed.py

This script defines the DefinitionRepositoryChangesPushed class.
...
class DefinitionRepositoryChangesPushed(NewDomainEvent):
    """
    Represents the initial changes in the domain repository have been pushed.

    Class name: DefinitionRepositoryChangesPushed
    ...
    def __init__(
        ...
        """
        Creates a new DefinitionRepositoryChangesPushed instance.
    ...
    async def maybe_trigger(self) -> List[NewDomainCreated]:
        """
        Triggers new events.
        :return: The triggered events.
        :rtype: List[pythoneda.tools.artifact.new_domain.events.NewDomainCreated]
        """
        return [
            NewDomainCreated(
                self.org,
