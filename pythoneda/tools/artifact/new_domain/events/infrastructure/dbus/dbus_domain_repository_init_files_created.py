...
"""
pythoneda/tools/artifact/new_domain/events/infrastructure/dbus/dbus_domain_repository_init_files_created.py

This file defines the DbusDomainRepositoryInitFilesCreated class.
...
class DbusDomainRepositoryInitFilesCreated(DbusNewDomainEvent):
    """
    D-Bus interface for DomainRepositoryInitFilesCreated.

    Class name: DbusDomainRepositoryInitFilesCreated

    Responsibilities:
        - Define the d-bus interface for the DomainRepositoryInitFilesCreated event.
    ...
    def __init__(self):
        """
        Creates a new DbusDomainRepositoryInitFilesCreated.
        """
        super().__init__()

    @signal()
    def DomainRepositoryInitFilesCreated(
        self,
        org: "s",
        name: "s",
        description: "s",
    ...
    def event_class(cls):
        ...
        :return: Such class.
        :rtype: type(pythoneda.tools.artifact.new_domain.DomainRepositoryInitFilesCreated)
        """
