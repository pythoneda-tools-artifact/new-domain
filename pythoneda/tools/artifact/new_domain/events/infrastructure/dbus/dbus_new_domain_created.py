...
class DbusNewDomainCreated(DbusNewDomainEvent):
    """
    ...
    def name(cls) -> str:
        ...
        :rtype: str
        """
        return "Pythoneda_Tools_Artifact_NewDomain_NewDomainCreated"
    ...
    def event_class(cls):
        ...
        :return: Such class.
        :rtype: type(pythoneda.tools.artifact.new_domain.NewDomainCreated)
        """
