...
"""
pythoneda/tools/artifact/new_domain/events/infrastructure/dbus/dbus_definition_repository_pyprojecttoml_template_requested.py

This file defines the DbusDefinitionRepositoryPyprojecttomlTemplateRequested class.
...
class DbusDefinitionRepositoryPyprojecttomlTemplateRequested(DbusNewDomainEvent):
    """
    D-Bus interface for DefinitionRepositoryPyprojecttomlTemplateRequested.

    Class name: DbusDefinitionRepositoryPyprojecttomlTemplateRequested

    Responsibilities:
        - Define the d-bus interface for the DefinitionRepositoryPyprojecttomlTemplateRequested event.
    ...
    def __init__(self):
        """
        Creates a new DbusDefinitionRepositoryPyprojecttomlTemplateRequested.
        """
        super().__init__()

    @signal()
    def DefinitionRepositoryPyprojecttomlTemplateRequested(
        self,
        org: "s",
        name: "s",
        description: "s",
    ...
    def event_class(cls):
        ...
        :return: Such class.
        :rtype: type(pythoneda.tools.artifact.new_domain.DefinitionRepositoryPyprojecttomlTemplateRequested)
        """
