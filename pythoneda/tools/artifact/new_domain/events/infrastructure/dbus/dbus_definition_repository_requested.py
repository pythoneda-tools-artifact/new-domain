...
class DbusDefinitionRepositoryRequested(BaseObject, ServiceInterface):
    """
    ...
    def __init__(self):
        ...
        """
        super().__init__(
            "Pythoneda_Tools_Artifact_DefinitionRepository_Events_DefinitionRepositoryRequested"
        )
    ...
    @classmethod
    def transform(cls, event: DefinitionRepositoryRequested) -> List[str]:
        """
        Transforms given event to signal parameters.
        :param event: The event to transform.
        :type event: pythoneda.shared.runtime.events.lifecycle.DefinitionRepositoryRequested
    ...
    @classmethod
    def sign(cls, event: DefinitionRepositoryRequested) -> str:
        """
    ...
    @classmethod
    def parse(cls, message: Message) -> DefinitionRepositoryRequested:
        """
        Parses given d-bus message containing a DefinitionRepositoryRequested event.
        :param message: The message.
        :type message: dbus_next.Message
        :return: The DefinitionRepositoryRequested event.
        :rtype: pythoneda.shared.runtime.events.lifecycle.DefinitionRepositoryRequested
        """
        (
            org,
            name,
