...
"""
pythoneda/tools/artifact/new_definition/events/infrastructure/dbus/dbus_definition_repository_pyprojecttoml_template_created.py
...
class DbusDefinitionRepositoryPyprojecttomlTemplateCreated(DbusNewDomainEvent):
    ...
    def event_class(cls):
        ...
        :return: Such class.
        :rtype: type(pythoneda.tools.artifact.new_definition.DefinitionRepositoryPyprojecttomlTemplateCreated)
        """
