...
class DbusDefinitionRepositoryReadmeCreated(DbusNewDomainEvent):
    """
    D-Bus interface for DefinitionRepositoryReadmeCreated.

    Class name: DbusDefinitionRepositoryReadmeCreated

    Responsibilities:
        - Define the d-bus interface for the DefinitionRepositoryReadmeCreated event.
    ...
    def __init__(self):
        """
        Creates a new DbusDefinitionRepositoryReadmeCreated.
        """
        super().__init__()

    @signal()
    def DefinitionRepositoryReadmeCreated(
        self,
        org: "s",
        name: "s",
        description: "s",
    ...
    def name(cls) -> str:
        ...
        :rtype: str
        """
        return "Pythoneda_Tools_Artifact_NewDomain_DefinitionRepositoryReadmeCreated"
