...
class DbusDomainRepositoryCreated(DbusNewDomainEvent):
    """
    ...
    def name(cls) -> str:
        ...
        :rtype: str
        """
        return "Pythoneda_Tools_Artifact_NewDomain_DomainRepositoryCreated"
    ...
    def event_class(cls):
        ...
        :return: Such class.
        :rtype: type(pythoneda.tools.artifact.new_domain.DomainRepositoryCreated)
        """
