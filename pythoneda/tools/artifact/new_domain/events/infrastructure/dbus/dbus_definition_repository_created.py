...
class DbusDefinitionRepositoryCreated(BaseObject, ServiceInterface):
    """
    ...
    def __init__(self):
        ...
        """
        super().__init__(
            "Pythoneda_Tools_Artifact_DefinitionRepository_Events_DefinitionRepositoryCreated"
        )

    @signal()
    def DefinitionRepositoryCreated(self, url: "s", defUrl: "s"):
        """
    ...
    @classmethod
    def transform(cls, event: DefinitionRepositoryCreated) -> List[str]:
        """
        Transforms given event to signal parameters.
        :param event: The event to transform.
        :type event: pythoneda.shared.runtime.events.lifecycle.DefinitionRepositoryCreated
    ...
    @classmethod
    def sign(cls, event: DefinitionRepositoryCreated) -> str:
        """
    ...
    @classmethod
    def parse(cls, message: Message) -> DefinitionRepositoryCreated:
        """
        Parses given d-bus message containing a DefinitionRepositoryCreated event.
        :param message: The message.
        :type message: dbus_next.Message
        :return: The DefinitionRepositoryCreated event.
        :rtype: pythoneda.shared.runtime.events.lifecycle.DefinitionRepositoryCreated
        """
