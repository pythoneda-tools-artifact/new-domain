...
"""
pythoneda/tools/artifact/new_domain/events/definition_repository_created.py
...
class DefinitionRepositoryCreated(NewDomainEvent):
    ...
    async def maybe_trigger(self) -> List[DefinitionRepositoryCloneRequested]:
        """
        Triggers new events.
        :return: The triggered events.
        :rtype: List[pythoneda.tools.artifact.new_domain.events.DefinitionRepositoryCloneRequested]
        """
        return [
